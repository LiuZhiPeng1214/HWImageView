package com.huwen.imagelibrary.fresco;
...
import com.huwen.imagelibrary.base.IHWImageView;

import okhttp3.OkHttpClient;

public class FrescoImageView extends SimpleDraweeView implements IHWImageView {
    GenericDraweeHierarchy hierarchy;
    GenericDraweeHierarchyBuilder builder;
    IHWImageLoadListener loadListener;
    String imageUrl;
    int imageRes;
